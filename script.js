...
function generatePDF() {
    ...
    doc.text('Program: B.Sc. in CSE, Year: ${year}, Semester: ${semester}',pageWidth / 2, 90, null, null, "center");
    ...
    doc.setFontSize(14);
    doc.setTextColor(0); 
    doc.text("Submitted by", pageWidth / 2, 160, null, null, "center");
    doc.setLineWidth(0.5);
    doc.setDrawColor(0); 
    doc.line(80, 162, pageWidth - 80, 162); 
